...
function BedCount() {
  return (
    <div className="container col-span-3">
      <h1 className="text-3xl text-sky-900 font-bold mb-4">Vacancies</h1>
      <div className="flex flex-col gap-2">
        <h1 className="font-bold text-sky-700">First Floor</h1>
        ...
        <h1 className="font-bold text-sky-700">Second Floor</h1>
        <div className="flex gap-4 flex-wrap">
          {beds
            .filter((floor) => {
